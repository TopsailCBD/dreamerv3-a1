...
from envs.legged_robot_wrapper import LeggedRobotDreamer
...
class DreamerRunner():
    def __init__(self,
        ...
        # TODO: modify the wrapper for a Parallel-like output, i.e. self.train_envs = LeggedRobotDreamer(env)
        self.train_envs = [Damy(LeggedRobotDreamer(env))]
        self.eval_envs = [Damy(LeggedRobotDreamer(env))]
